...
public interface CAEnchantment {
     ...
     */
    boolean isAllowed(HumanEntity player);
     ...
     */
    void addConflict(EnchantConflictGroup conflict);
     ...
     */
    void removeConflict(EnchantConflictGroup conflict);
     ...
     */
    boolean isEnchantmentPresent(ItemStack item);
     ...
     * @return If the enchantment have been found.
     */
    boolean isEnchantmentPresent(ItemStack item, ItemMeta meta);
     ...
     */
    void addEnchantmentUnsafe(ItemStack item, int level);
     ...
     */
    void removeFrom(ItemStack item);
     ...
     */
    static void clearEnchants(ItemStack item) {
     ...
     */
    static Map<CAEnchantment, Integer> getEnchants(ItemStack item) {
    ...
    static void findEnchantsFromSelectedList(
            ...
            Collection<CAEnchantment> enchantmentToTest) {
     ...
     */
    static List<CAEnchantment> getByName(String name) {
